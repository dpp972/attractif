...
use MainBundle\Form\EntrepriseType;
...
class EntrepriseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MainBundle:Entreprise')->findAll();
     ...
     * @Method("POST")
     * @Template("MainBundle:Entreprise:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Entreprise')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MainBundle:Entreprise:edit.html.twig")
     */
