...
use MainBundle\Form\ProduitType;
...
class ProduitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MainBundle:Produit')->findAll();
     ...
     * @Method("POST")
     * @Template("MainBundle:Produit:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Produit')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MainBundle:Produit:edit.html.twig")
     */
