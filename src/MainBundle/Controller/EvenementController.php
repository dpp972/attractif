...
class EvenementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MainBundle:Evenement')->findAll();
     ...
     * @Method("POST")
     * @Template("MainBundle:Evenement:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Evenement')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MainBundle:Evenement:edit.html.twig")
     */
